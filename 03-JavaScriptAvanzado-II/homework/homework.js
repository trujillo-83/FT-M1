...
function cacheFunction(cb) {
  ...
  */
  ...
  let cache = {} // Creamos un objeto vacio

  return function (obj) {
    if (!cache.hasOwnProperty(obj)) {
      cache[obj] = cb(obj) // Buscar si tengo cache[x] y si no tengo, ejecuta el cb y asigno un valor
    }
    return cache[obj] // Devuelve el valor de cache
  }
}
