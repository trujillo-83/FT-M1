...
function nFactorial(n) {
  ...
  if (n > 0 && n < 2) { //if (n > -1 && n < 2), hace una validacion y si es 0 o 1, retorna 1 directamente
    return 1;           // else if (n < 0 === 0)
  }
  return n * nFactorial(n-1); //else
}
...
function nFibonacci(n) {
  if (n >= 0 && n < 2) { //if n === 1 return 1 // if n === 0 return 0; o if (n < 2) return n
    return n;
  }
